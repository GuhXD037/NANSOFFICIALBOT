...
const connectionOptions = {
  ...
  browser: ['𝙉𝘼𝙉𝙎 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇','Safari','1.0.0']
}
...
setInterval(async () => {
	...
	console.log(chalk.cyan(`✅  Auto clear  | Folder tmp dibersihkan`))
}, 60000) //1 munto
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = 'adiós @user'
  conn.spromote = '@user dipromosikan menjadi admin'
  conn.sdemote = '@user Rusak'

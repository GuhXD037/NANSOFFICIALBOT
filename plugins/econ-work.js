...
let handler = async (m, { conn, usedPrefix, command }) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastwork < 3600000) throw `*🧘🏻‍♂️ Anda lelah* dan karena itu harus menunggu *${msToTime(time - new Date())}* untuk kembali bekerja!`
